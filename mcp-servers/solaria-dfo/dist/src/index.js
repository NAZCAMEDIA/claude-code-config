...
const tools = [
    {
        ...
        description: 'Establecer contexto de proyecto para aislar sesion (LLAMAR PRIMERO). Esta herramienta es CRITICA para multi-agent working. Debe llamarse al inicio de cada sesion para asegurar que el agente trabaje solo en el proyecto asignado y no contamine datos de otros proyectos.',
    },
    {
    ...
    {
        name: 'get_project',
        description: 'Obtener detalles de un proyecto especifico',
    },
    {
        name: 'update_project',
        description: 'Actualizar informacion de un proyecto',
    },
    {
        name: 'list_tasks',
    ...
    },
    {
        ...
        description: 'Tareas listas para trabajar (DFN-004). Retorna tareas sin bloqueadores con scoring inteligente (0-100). Usa este endpoint para priorizar que trabajar a continuacion.',
    },
    {
        name: 'create_task',
    ...
    {
        name: 'update_task',
        description: 'Actualizar informacion de una tarea',
    },
    {
        name: 'complete_task',
    ...
    {
        name: 'get_agent',
        description: 'Obtener estado de un agente especifico',
    },
    {
    ...
    {
        name: 'log_activity',
        description: 'Registrar actividad en DFO (auditoria)',
    },
    {
        name: 'memory_create',
    ...
    {
        name: 'memory_get',
        description: 'Obtener memoria especifica (incrementa contador de acceso)',
    },
    {
        name: 'memory_update',
    ...
    {
        name: 'memory_search',
        description: 'Busqueda full-text en memorias',
    },
    {
        name: 'memory_semantic_search',
        description: 'Busqueda semantica con vectores de embeddings',
    },
    {
        name: 'memory_boost',
        description: 'Aumentar importancia de una memoria util',
    },
    {
        name: 'memory_related',
    ...
    {
        name: 'memory_link',
        description: 'Crear relacion entre dos memorias',
    },
];
...
server.setRequestHandler('tools/call', async (request) => {
    ...
    try {
        console.error(`[SOLARIA-DFO MCP] Calling: ${name}`, JSON.stringify(args));
