...
const { StdioServerTransport } = require('@modelcontextprotocol/sdk/dist/esm/server/stdio.js');
const { Server } = require('@modelcontextprotocol/sdk/dist/esm/server/index.js');
...
const tools = [
  ...
  { name: 'memory_semantic_search', description: 'Busqueda semantica' },
